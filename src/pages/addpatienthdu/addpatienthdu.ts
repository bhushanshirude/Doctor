...
@Component({
  selector: 'page-addpatienthdu',
  templateUrl: 'addpatienthdu.html',
})
export class AddpatienthduPage {
  isSubmitted: 'true';
  h_id;
  doctor_id;
  Api_url = "";
  ...
  constructor(public navCtrl: NavController, public services: AllServiceProvider, public barcodeScanner: BarcodeScanner, public menu: MenuController, public navParams: NavParams, public toastCtrl: ToastController, public storage: Storage, public appCtrl: App) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddpatienthduPage');
  }
