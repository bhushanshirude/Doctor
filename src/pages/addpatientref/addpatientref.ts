...
@Component({
  selector: 'page-addpatientref',
  templateUrl: 'addpatientref.html',
})
export class AddpatientrefPage {
  isSubmitted: 'true';
  h_id;
  doctor_id;
  Api_url = "";
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public barcodeScanner: BarcodeScanner, public toastCtrl: ToastController, public appCtrl: App, public services: AllServiceProvider, public storage: Storage) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddpatientrefPage');
  }
