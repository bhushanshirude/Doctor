...
import { AddpatientextraPage } from '../addpatientextra/addpatientextra';
...
export class ExtraPage {
  ...
  add() {
    this.appCtrl.getRootNavs()[0].push(AddpatientextraPage)
  }
  ...
  ngOnInit() {
    this.storage.get('patient_extra').then((val) => {
