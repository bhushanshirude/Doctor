...
import { AddpatientrefPage } from '../addpatientref/addpatientref';
...
export class RefPage {
  ...
  ward_status;
  value;
  constructor(public navCtrl: NavController, public navParams: NavParams, public popoverCtrl: PopoverController, public appCtrl: App, public services: AllServiceProvider, public storage: Storage) {
  ...
  add() {
    this.appCtrl.getRootNavs()[0].push(AddpatientrefPage)
  }
  ...
  ngOnInit() {
    this.storage.get('patient_ref').then((val) => {
