...
@Component({
  selector: 'page-addpatientspw',
  templateUrl: 'addpatientspw.html',
})
export class AddpatientspwPage {
  isSubmitted: 'true';
  h_id;
  doctor_id;
  Api_url = "";
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public barcodeScanner: BarcodeScanner, public menu: MenuController, public appCtrl: App, public toastCtrl: ToastController, public services: AllServiceProvider, public storage: Storage) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddpatientspwPage');
  }
  ...
  Submit(addform) {
    console.log("SPW ANILLLLLLLLLLLLLL");
