...
@Component({
  selector: 'page-addpatientot',
  templateUrl: 'addpatientot.html',
})
export class AddpatientotPage {
  isSubmitted: 'true';
  s_id;
  h_id;
  doctor_id;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public menu: MenuController, public barcodeScanner: BarcodeScanner, public services: AllServiceProvider, public toastCtrl: ToastController, public storage: Storage, public appCtrl: App) {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AddpatientotPage');
  }
      ...
      fetch(this.Api_url + 'users/android_addpatient', {
        ...
        .then(data => {
          if (data.Status == "Success") {
            ...
            console.log("Ot patinent not work")
          }
        });
    }
  }
