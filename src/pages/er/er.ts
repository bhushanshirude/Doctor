...
import { AddpatienterPage } from '../addpatienter/addpatienter';
...
export class ErPage {
  ...
  ward_status;
  value;
  constructor(public navCtrl: NavController, public appCtrl: App, public storage: Storage, public popoverCtrl: PopoverController, public navParams: NavParams, public services: AllServiceProvider) {
    this.Api_url = this.services.user_api;
    this.storage.get('patient_er').then((val) => {
    })
  ...
  add() {
    this.appCtrl.getRootNavs()[0].push(AddpatienterPage)
  }

  ionViewDidLoad() {
    console.log('ionViewDidLoad ErPage');
  }
